...
int main()
{
    ...
    VectorXd y_train{load_csv<MatrixXd>("data/y_train_poisson.csv")};    
    VectorXd y_test{load_csv<MatrixXd>("data/y_test_poisson.csv")}; 
    ...
    tests.push_back(is_approximately_equal(predictions.mean(),1.89408,0.00001));
