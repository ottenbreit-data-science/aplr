...
PYBIND11_MODULE(aplr_cpp, m)
{
    ...
    py::class_<CppDataFrame, std::unique_ptr<CppDataFrame>>(m, "CppDataFrame", py::module_local())
        ...
        .def("add_numeric_column", [](CppDataFrame &self, const std::string &name, const Eigen::VectorXd &col)
            ...
            self.add_column(name, std::move(std_col)); }, py::arg("name"), py::arg("data"))
    ...
    py::class_<APLRRegressor>(m, "APLRRegressor", py::module_local())
        ...
        .def("set_progress_callback", &APLRRegressor::set_progress_callback, py::arg("callback"))
        .def("clear_progress_callback", &APLRRegressor::clear_progress_callback)
        ...
        .def(py::pickle(
            ...
            [](py::tuple t) { // __setstate__
                ...
                double min_observations_in_split = t[17].cast<double>();
    ...
    py::class_<APLRClassifier>(m, "APLRClassifier", py::module_local())
        ...
        .def("set_progress_callback", &APLRClassifier::set_progress_callback, py::arg("callback"))
        .def("clear_progress_callback", &APLRClassifier::clear_progress_callback)
        ...
        .def(py::pickle(
            ...
            [](py::tuple t) { // __setstate__
                ...
                double min_observations_in_split = t[9].cast<double>();
