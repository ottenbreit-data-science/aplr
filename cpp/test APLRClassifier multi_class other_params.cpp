...
int main()
{
    ...
    VectorXd feature_importance_correct{0.2*(feature_importance_model1+feature_importance_model2+feature_importance_model3
        +feature_importance_model4+feature_importance_model5)};
    ...
    tests.push_back(is_approximately_equal(model.get_validation_error(),0.121648,0.000001));
    ...
    tests.push_back(is_approximately_equal(local_feature_importance.mean(),0.157701,0.00001));
